    ...
    <footer className="bg-forest py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <span className="text-2xl font-heading font-bold text-primary-foreground">KinéMove</span>
        ...
        <div className="border-t border-primary-foreground/20 pt-6 text-center">
          <p className="text-xs text-primary-foreground/50 font-body">© {new Date().getFullYear()} KinéMove. {tr(t.footer.rights)}.</p>
        </div>
      </div>
    </footer>
  );
